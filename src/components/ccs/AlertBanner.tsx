  ...
  return (
    ...
    >
      ...
      <div className="flex min-w-0 flex-1 items-center gap-[0.75rem] lg:gap-[0.8125rem]">
        ...
        <div
          className="
            flex h-[1.6rem] w-[1.6rem] shrink-0
            items-center justify-center
            xl:h-[1.75rem] xl:w-[1.75rem]
          "
        >
          <img
            src={alertIcon}
            ...
            className="
              ...
              xl:h-[1.53125rem] xl:w-[1.53125rem]
            "
          />
        </div>
        ...
        <p
          className="
            line-clamp-2
            text-[0.8125rem] font-normal leading-[120%] text-[#4E4E4E]
            lg:text-[0.875rem]
          "
        >
      ...
      <button
        className="
          flex h-[2.875rem] w-[2.875rem] shrink-0
          items-center justify-center
          rounded-full border-2 border-[#4E4E4E]
          bg-transparent transition-colors
          hover:bg-[var(--primary-soft)]
          xl:h-[3.25rem] xl:w-[3.25rem]
