...
export default function CalendarPopover({ 
  ...
  return (
    <div ref={popoverRef} className={`w-[284px] bg-[#FFFFFF] shadow-[0px_4px_6px_rgba(0,0,0,0.1),0px_10px_20px_rgba(0,0,0,0.15)] rounded-[12px] z-50 flex flex-col p-[16px] gap-[8px] max-h-[calc(100vh-12px)] overflow-y-auto pointer-events-auto`}>
        ...
        <div className="flex items-center justify-end gap-[8px]">
          ...
          {mode === "range" && (
            <button 
              ...
              className="flex items-center justify-center w-[66px] h-[32px] bg-[#2780C4] rounded-[8px] transition-colors hover:bg-blue-600 disabled:opacity-50"
            >
