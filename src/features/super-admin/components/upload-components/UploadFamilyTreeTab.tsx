...
export const UploadFamilyTreeTab: React.FC<UploadFamilyTreeTabProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col justify-start items-center relative w-full mt-4 animate-in fade-in duration-300">
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <span className="font-['Hanken_Grotesk'] font-bold text-[clamp(0.55rem,0.8vw,0.95rem)] leading-none tracking-[1.1px] text-black uppercase">
                FATHER
              </span>
            </div>
            {/* Card Content Box */}
            ...
            >
              ...
              <div className="flex flex-col justify-center items-start overflow-hidden w-full">
                {isFatherFilled ? (
                  <>
                    <span className="font-['Plus_Jakarta_Sans'] font-semibold text-[clamp(0.65rem,1.2vw,0.95rem)] text-[#3E4A3D] truncate w-full">
                      {fatherName}
                    </span>
                    <span className="font-['Plus_Jakarta_Sans'] font-normal text-[clamp(0.45rem,0.8vw,0.65rem)] text-gray-400">
                      Click to edit
                    </span>
                  </>
                ) : (
                  <div className="flex items-center gap-2 text-[#3E4A3D] font-semibold text-[clamp(0.65rem,1.2vw,0.95rem)]">
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-center text-center w-full">
                {isOwnerFilled ? (
                  <>
                    <span className="font-['Plus_Jakarta_Sans'] font-bold text-[clamp(0.75rem,1.4vw,1.1rem)] text-[#3E4A3D] leading-tight truncate w-full">
                      {ownerName}
                    </span>
                    <span className="font-['Plus_Jakarta_Sans'] font-normal text-[clamp(0.45rem,0.8vw,0.65rem)] text-gray-400 mt-0.5">
                      Click to edit
                    </span>
                  </>
                ) : (
                  <div className="flex items-center gap-2 text-[#3E4A3D] font-semibold text-[clamp(0.75rem,1.4vw,1.1rem)]">
        ...
        <button
          ...
          className="box-sizing-border-box flex flex-row items-center justify-center gap-2 bg-[#2E3509] hover:bg-[#1D2206] text-white rounded-[clamp(1rem,2vw,2rem)] shadow-[0px_2px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-1px_rgba(0,0,0,0.06)] transition-all cursor-pointer absolute"
          style={{
            width: "16.59%",
            height: "7.10%",
        ...
        >
          <div className="w-[clamp(1.1rem,1.5vw,1.4rem)] h-[clamp(1.1rem,1.5vw,1.4rem)] rounded-full bg-white flex items-center justify-center shrink-0">
            <Plus className="w-[clamp(0.6rem,0.9vw,0.8rem)] h-[clamp(0.6rem,0.9vw,0.8rem)] text-[#6E7B6C]" />
          </div>
          <span className="font-['Plus_Jakarta_Sans'] font-semibold text-[clamp(0.55rem,0.9vw,0.8rem)] text-white whitespace-nowrap">
            Add Member
          </span>
        </button>
        ...
        >
          <span className="font-['Plus_Jakarta_Sans'] font-normal text-[clamp(0.65rem,0.9vw,1.1rem)] text-[rgba(0,0,0,0.48)] select-none">
            {zoomLevel}%
          </span>
          <div className="flex flex-col gap-2">
            <button
              ...
              className="w-[clamp(1.5rem,2.1vw,1.875rem)] h-[clamp(1.6rem,2.2vw,2rem)] bg-[#FAFAFA] hover:bg-gray-100 rounded flex items-center justify-center cursor-pointer shadow-[0px_1px_4px_rgba(0,0,0,0.12)] active:scale-95 transition-all text-[#716E6E]"
            >
            ...
            <button
              ...
              className="w-[clamp(1.5rem,2.1vw,1.875rem)] h-[clamp(1.6rem,2.2vw,2rem)] bg-[#FAFAFA] hover:bg-gray-100 rounded flex items-center justify-center cursor-pointer shadow-[0px_0px_4px_rgba(0,0,0,0.12)] active:scale-95 transition-all text-[#716E6E]"
            >
      ...
      <div 
        className="flex flex-row justify-end items-center gap-[clamp(1rem,1.67vw,2.5rem)] pt-[clamp(1rem,1.5vw,1.5rem)] border-t border-gray-100 mt-[clamp(1rem,1.5vw,1.5rem)] w-full"
        style={{
          maxWidth: "clamp(38.31rem, 59.86vw, 71.83rem)"
        }}
      >
        <button
          type="button"
          onClick={() => setActiveTab("owner")}
          className="font-['Plus_Jakarta_Sans'] font-medium text-black hover:opacity-75 uppercase cursor-pointer tracking-wider text-[clamp(0.75rem,0.97vw,0.875rem)] flex items-center justify-center"
        >
          Back
        </button>
        <button
          ...
          className="flex items-center justify-center text-white rounded-[57px] shadow-lg hover:scale-105 active:scale-95 cursor-pointer font-['Plus_Jakarta_Sans'] font-normal w-[clamp(5.5rem,7vw,6.25rem)] h-[clamp(2.5rem,3.26vw,2.9375rem)]"
          style={{
            background: "radial-gradient(50% 50% at 50% 50%, #3D4A0D 0%, #2A3008 100%)"
          }}
        >
          <span className="font-['Plus_Jakarta_Sans'] font-normal text-white text-[clamp(1rem,1.25vw,1.125rem)]">
            Next
          </span>
        </button>
      </div>
