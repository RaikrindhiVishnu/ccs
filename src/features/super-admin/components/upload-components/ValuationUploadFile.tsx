  ...
  return (
    ...
    >
      ...
      {activeTabLabel === "Road Approach" ? (
        <div className="absolute flex flex-col items-start p-0 gap-[clamp(0.93rem,_1.94vw,_2.33rem)] w-[50.15%] h-[clamp(6.53rem,_13.61vw,_16.33rem)] left-[1.32%] top-[clamp(1rem,_2.08vw,_2.5rem)]">
          {/* Frame 2147239912 */}
          <div className="flex flex-col items-start p-0 gap-[clamp(0.6rem,_1.25vw,_1.5rem)] w-full h-[clamp(2.87rem,_5.97vw,_7.17rem)]">
            ...
            {/* Frame 2147239911 */}
            <div className="flex flex-row items-center p-0 gap-[clamp(0.84rem,_1.74vw,_2.08rem)] w-[clamp(12.24rem,_25.49vw,_30.58rem)] h-[clamp(1.27rem,_2.64vw,_3.17rem)]">
              {/* Frame 2147239876 */}
              <button
                type="button"
                onClick={() => onBoundaryRoadTypeChange?.("Private Road")}
                className={`box-border flex flex-row justify-center items-center py-[clamp(0.33rem,_0.69vw,_0.83rem)] px-[clamp(0.6rem,_1.25vw,_1.5rem)] gap-[10px] w-[clamp(4.77rem,_9.93vw,_11.92rem)] h-[clamp(1.27rem,_2.64vw,_3.17rem)] border rounded-[33px] cursor-pointer transition-all ${
              ...
              <button
                ...
                className={`box-border flex flex-row justify-center items-center py-[clamp(0.33rem,_0.69vw,_0.83rem)] px-[clamp(0.6rem,_1.25vw,_1.5rem)] gap-[10px] w-[clamp(6.63rem,_13.82vw,_16.58rem)] h-[clamp(1.27rem,_2.64vw,_3.17rem)] border rounded-[33px] cursor-pointer transition-all ${
          ...
          {/* Frame 2147239910 */}
          <div className="flex flex-col items-start p-0 gap-[clamp(0.27rem,_0.56vw,_0.67rem)] w-full h-[clamp(2.73rem,_5.69vw,_6.83rem)]">
            <span className="font-['Plus_Jakarta_Sans',_sans-serif] font-semibold text-[clamp(0.53rem,_1.11vw,_1.33rem)] leading-[clamp(0.67rem,_1.39vw,_1.67rem)] text-[rgba(0,_0,_0,_0.92)]">
            ...
            <input
              ...
              className="box-border w-full max-w-[clamp(17.87rem,_37.22vw,_44.67rem)] h-[clamp(1.8rem,_3.75vw,_4.5rem)] bg-white border border-[rgba(0,_0,_0,_0.4)] rounded-[8px] px-4 outline-none text-black font-['Plus_Jakarta_Sans',_sans-serif] text-[clamp(0.53rem,_1.11vw,_1.33rem)]"
            />
          </div>
        </div>
      ) : activeTabLabel === "Recent Transactions" ? (
        <div className={`absolute flex flex-col items-start p-0 gap-[clamp(0.93rem,_1.94vw,_2.33rem)] w-[50.15%] left-[1.32%] top-[clamp(1rem,_2.08vw,_2.5rem)] transition-all ${
          recentTransactionTypeValue === "Available"
            ? "h-[clamp(10.2rem,_21.25vw,_25.5rem)]"
            : "h-[clamp(2.87rem,_5.97vw,_7.17rem)]"
        }`}>
          {/* Frame 2147239912 */}
          <div className="flex flex-col items-start p-0 gap-[clamp(0.6rem,_1.25vw,_1.5rem)] w-full h-[clamp(2.87rem,_5.97vw,_7.17rem)]">
            <span className="font-['Plus_Jakarta_Sans',_sans-serif] font-semibold text-[clamp(0.8rem,_1.67vw,_2rem)] leading-[clamp(1rem,_2.08vw,_2.5rem)] text-black">
            ...
            {/* Frame 2147239911 */}
            <div className="flex flex-row items-center p-0 gap-[clamp(0.84rem,_1.74vw,_2.08rem)] w-[clamp(10.23rem,_21.32vw,_25.58rem)] h-[clamp(1.27rem,_2.64vw,_3.17rem)]">
              {/* Frame 2147239878 */}
              <button
                type="button"
                onClick={() => onRecentTransactionTypeChange?.("Available")}
                className={`box-border flex flex-row justify-center items-center py-[clamp(0.33rem,_0.69vw,_0.83rem)] px-[clamp(0.6rem,_1.25vw,_1.5rem)] gap-[10px] w-[clamp(4.5rem,_9.38vw,_11.25rem)] h-[clamp(1.27rem,_2.64vw,_3.17rem)] border rounded-[33px] cursor-pointer transition-all ${
                  recentTransactionTypeValue === "Available"
                    ? "border-[#22252A] bg-[#22252A]"
                    : "border-[rgba(0,_0,_0,_0.26)] bg-white"
                }`}
              ...
              <button
                ...
                className={`box-border flex flex-row justify-center items-center py-[clamp(0.33rem,_0.69vw,_0.83rem)] px-[clamp(0.6rem,_1.25vw,_1.5rem)] gap-[10px] w-[clamp(4.9rem,_10.21vw,_12.25rem)] h-[clamp(1.27rem,_2.64vw,_3.17rem)] border rounded-[33px] cursor-pointer transition-all ${
        ...
        <div className="absolute flex flex-col items-start p-0 gap-[clamp(0.93rem,_1.94vw,_2.33rem)] w-[50.15%] h-[clamp(2.87rem,_5.97vw,_7.17rem)] left-[1.32%] top-[clamp(1rem,_2.08vw,_2.5rem)]">
          {/* Frame 2147239912 */}
          <div className="flex flex-col items-start p-0 gap-[clamp(0.6rem,_1.25vw,_1.5rem)] w-full h-full">
            <span className="font-['Plus_Jakarta_Sans',_sans-serif] font-semibold text-[clamp(0.8rem,_1.67vw,_2rem)] leading-[clamp(1rem,_2.08vw,_2.5rem)] text-black">
        ...
        <div className="absolute flex flex-col items-start p-0 gap-[clamp(0.75rem,_1.56vw,_1.88rem)] w-[50.15%] h-[clamp(8.34rem,_17.38vw,_20.85rem)] left-[1.32%] top-[clamp(1rem,_2.08vw,_2.5rem)]">
          <span className="font-['Plus_Jakarta_Sans',_sans-serif] font-semibold text-[clamp(0.8rem,_1.67vw,_2rem)] leading-[clamp(1rem,_2.08vw,_2.5rem)] text-black">
            {activeTabLabel === "Future Plans"
              ? "Future Plans of Geological Advantages"
              : "Validating the Disadvantages of the Land"}
          </span>
          <div className="relative w-full h-[clamp(6.03rem,_12.56vw,_15.08rem)]">
            <Comments
        ...
        <div className="absolute flex flex-col items-start p-0 gap-[clamp(0.43rem,_0.9vw,_1.08rem)] w-[50.15%] h-[clamp(3.24rem,_6.74vw,_8.08rem)] left-[1.32%] top-[clamp(1rem,_2.08vw,_2.5rem)]">
          ...
          {/* Frame 2147239871 */}
          <div className="relative w-full max-w-[clamp(17.87rem,_37.22vw,_44.67rem)] h-[clamp(1.8rem,_3.75vw,_4.5rem)]">
            <select
              value={upcomingInfrastructuresValue}
              onChange={(e) => onUpcomingInfrastructuresChange?.(e.target.value)}
              className="appearance-none box-border w-full h-full bg-white border border-[rgba(0,_0,_0,_0.4)] rounded-[8px] px-4 outline-none text-black font-['Plus_Jakarta_Sans',_sans-serif] text-[clamp(0.53rem,_1.11vw,_1.33rem)] pr-10 cursor-pointer"
            >
            ...
            <div className="pointer-events-none absolute right-4 top-1/2 -translate-y-1/2 flex items-center justify-center">
              <svg
                className="w-[clamp(0.4rem,_0.83vw,_1rem)] h-[clamp(0.4rem,_0.83vw,_1rem)] text-[#363434]"
        ...
        <div
          className={`absolute flex flex-col items-start p-0 gap-[clamp(1.13rem,_2.36vw,_2.83rem)] w-[50.15%] left-[1.32%] top-[clamp(1rem,_2.08vw,_2.5rem)] transition-all ${
            railwayConnectivityTypeValue === "Available"
              ? "h-[clamp(7.44rem,_15.49vw,_18.58rem)]"
              : "h-[clamp(3.07rem,_6.39vw,_7.67rem)]"
          }`}
        >
          {/* Frame 2147239912 */}
          <div className="flex flex-col items-start p-0 gap-[clamp(0.8rem,_1.67vw,_2rem)] w-full h-[clamp(3.07rem,_6.39vw,_7.67rem)]">
            <span className="font-['Plus_Jakarta_Sans',_sans-serif] font-semibold text-[clamp(0.8rem,_1.67vw,_2rem)] leading-[clamp(1rem,_2.08vw,_2.5rem)] text-black">
              Any Railway Track Connectivity?
            </span>
            {/* Frame 2147239912 */}
            <div className="flex flex-row items-center p-0 gap-[clamp(0.84rem,_1.74vw,_2.08rem)] w-[clamp(9.73rem,_20.28vw,_24.33rem)] h-[clamp(1.27rem,_2.64vw,_3.17rem)]">
              {/* Frame 2147239880 */}
              <button
                type="button"
                onClick={() => onRailwayConnectivityTypeChange?.("Available")}
                className={`box-border flex flex-row justify-center items-center py-[clamp(0.33rem,_0.69vw,_0.83rem)] px-[clamp(0.6rem,_1.25vw,_1.5rem)] gap-[10px] w-[clamp(4rem,_8.33vw,_10rem)] h-[clamp(1.27rem,_2.64vw,_3.17rem)] border rounded-[33px] cursor-pointer transition-all ${
                  railwayConnectivityTypeValue === "Available"
                    ? "border-[#22252A] bg-[#22252A]"
                    : "border-[rgba(0,_0,_0,_0.26)] bg-white"
                }`}
