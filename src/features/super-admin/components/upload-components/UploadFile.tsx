...
const FileListItem: React.FC<{ file: UploadedFileItem, onFileDelete: (id: string) => void }> = ({ file, onFileDelete }) => (
  <div className="relative w-full shrink-0 h-[clamp(2.62rem,4.1vw,4.92rem)] bg-[#F6F9E2] rounded-[12px] mb-[4px]">
    <div className="flex items-center justify-center bg-white absolute w-[clamp(1.29rem,2.01vw,2.42rem)] h-[clamp(1.29rem,2.01vw,2.42rem)] left-[clamp(0.4rem,0.63vw,0.75rem)] top-[clamp(0.62rem,0.97vw,1.17rem)] rounded-[4px]">
      <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[clamp(0.8rem,1.25vw,1.5rem)] h-[clamp(0.8rem,1.25vw,1.5rem)]">
    ...
    <div className="flex flex-col justify-center absolute left-[clamp(2.04rem,3.19vw,3.83rem)] top-[clamp(0.62rem,0.97vw,1.17rem)] w-[50%] h-[clamp(1.33rem,2.08vw,2.5rem)]">
      <span className="truncate text-black font-['Inter',_sans-serif] font-normal text-[clamp(0.62rem,0.97vw,1.17rem)] leading-[clamp(0.76rem,1.18vw,1.42rem)] block">
        {file.name}
      </span>
      <span className="font-['Inter',_sans-serif] font-normal text-[clamp(0.36rem,0.56vw,0.67rem)] leading-[clamp(0.44rem,0.69vw,0.83rem)] text-[rgba(0,0,0,0.7)]">
        {file.size}
      </span>
    </div>
    ...
    <button
      ...
      className="flex items-center justify-center bg-white cursor-pointer hover:bg-red-50 hover:text-red-500 rounded transition-colors absolute w-[clamp(1.11rem,1.74vw,2.08rem)] h-[clamp(1.11rem,1.74vw,2.08rem)] right-[clamp(0.67rem,1.04vw,1.25rem)] top-[clamp(0.67rem,1.04vw,1.25rem)] rounded-[2px] border-none"
    >
  ...
  return (
    <>
      ...
      <div
        ...
        } box-border absolute w-[41.2%] h-[clamp(14.53rem,22.71vw,27.25rem)] left-[1.76%] top-[clamp(0.62rem,0.97vw,1.17rem)] border-2 border-dashed border-[rgba(225,229,239,0.6)] rounded-[12px]`}
      >
        <input
          ref={fileInputRef}
          type="file"
        ...
        <div className="flex items-center justify-center bg-[#E6EEAD] absolute w-[clamp(2.14rem,3.35vw,4.02rem)] h-[clamp(2.14rem,3.35vw,4.02rem)] left-[calc(50%-clamp(2.14rem,3.35vw,4.02rem)/2-0.38px)] top-[clamp(2.58rem,4.03vw,4.83rem)] rounded-[6030.65px]">
          ...
          <div className="flex items-center justify-center w-[clamp(1.72rem,2.68vw,3.22rem)] h-[clamp(1.72rem,2.68vw,3.22rem)] bg-[radial-gradient(circle_at_50%_50%,rgba(61,74,13,0.7812)_0%,rgba(42,48,8,0.84)_100%)] shadow-[0px_6px_9px_-1.8px_rgba(0,88,188,0.2),0px_2.4px_3.6px_-2.4px_rgba(0,88,188,0.2)] rounded-[6030.65px]">
            <svg
              ...
              className="w-[clamp(0.89rem,1.39vw,1.67rem)] h-[clamp(0.89rem,1.39vw,1.67rem)] text-white"
            >
        ...
        <div className="flex items-center gap-1 absolute w-[clamp(3.29rem,5.14vw,6.17rem)] h-[clamp(0.53rem,0.83vw,1.0rem)] left-[clamp(0.89rem,1.39vw,1.67rem)] top-[clamp(13.29rem,20.76vw,24.92rem)]">
          <svg
            ...
            stroke="currentColor"
            strokeWidth="1.2"
            className="w-[clamp(0.44rem,0.63vw,0.83rem)] h-[clamp(0.44rem,0.63vw,0.83rem)] text-black"
          >
      ...
      <div className="absolute w-[41.06%] h-[clamp(7.56rem,11.81vw,14.17rem)] left-[45.75%] top-[clamp(0.62rem,0.97vw,1.17rem)] flex flex-col items-start gap-[clamp(0.76rem,1.18vw,1.42rem)]">
        ...
        {/* Files List Frame */}
        <div className="flex flex-col items-start overflow-y-auto w-full custom-scrollbar h-[clamp(5.69rem,8.89vw,10.67rem)] gap-[clamp(0.44rem,0.69vw,0.83rem)] pr-[clamp(0.44rem,0.69vw,0.83rem)]">
          {groupByImageType ? (
            <>
