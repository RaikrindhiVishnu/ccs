  ...
  return (
    <div className="min-h-screen bg-[#F2F2F2] flex flex-col justify-start items-center p-[clamp(1.33rem,2.78vw,3.33rem)] font-sans">
      ...
      >
        ...
        {/* ── Central Card ── */}
        <div className="w-full bg-white shadow-[0px_20px_40px_rgba(0,49,50,0.06)] rounded-[clamp(1.07rem,2.22vw,2.0rem)] p-[clamp(1.6rem,3.33vw,4.0rem)] relative flex flex-col gap-[clamp(1.73rem,3.6vw,4.3rem)]">
          {/* Header Title */}
          <div>
            <h2 className="font-['Manrope'] font-bold text-[clamp(0.93rem,1.944vw,2.33rem)] leading-none text-[#1A1C1D]">
              Enter land details
            </h2>
          </div>

          {/* ── Body: Form Controls ── */}
          <div className="flex flex-col gap-[clamp(1.73rem,3.6vw,4.3rem)] w-full">

            {/* Row 1: Acquisition Category & Agent Referral stacked vertically */}
            <div className="flex flex-col gap-[clamp(0.96rem,2vw,2.5rem)]">

              {/* Acquisition Category Question */}
              <div className="flex flex-col gap-[clamp(0.53rem,1.1vw,1.25rem)]">
                <span className="font-['Plus_Jakarta_Sans'] font-medium text-[clamp(0.6rem,1.25vw,1.5rem)] leading-tight text-black">
                ...
                <div className="flex flex-row items-center gap-[clamp(0.75rem,1.8vw,2rem)]">
                  ...
                  <button
                    ...
                    className={`flex flex-row justify-center items-center gap-2.5 h-[clamp(1.27rem,2.64vw,3.17rem)] rounded-[33px] border transition-all cursor-pointer select-none ${acquisitionCategory === "purchase"
                      ? "bg-[#2B2D2F] border-[#000000] text-white"
                      : "bg-white border-[rgba(0,0,0,0.26)] text-black hover:bg-gray-50"
                      }`}
                    style={{ width: "clamp(5.03rem, 10.486vw, 12.5625rem)" }}
                  >
                    <div
                    ...
                    />
                    <span className="font-['Plus_Jakarta_Sans'] font-semibold text-[clamp(0.47rem,0.97vw,1.16rem)] leading-none whitespace-nowrap">
                      Self Purchase
                    </span>
                  </button>
                  ...
                  <button
                    ...
                    className={`flex flex-row justify-center items-center gap-2.5 h-[clamp(1.27rem,2.64vw,3.17rem)] rounded-[33px] border transition-all cursor-pointer select-none ${acquisitionCategory === "ancestral"
                      ? "bg-[#2B2D2F] border-[#000000] text-white"
                      : "bg-white border-[rgba(0,0,0,0.26)] text-black hover:bg-gray-50"
                      }`}
                    style={{ width: "clamp(6.17rem, 12.847vw, 15.416rem)" }}
                  >
                    <div
              ...
              <div className="flex flex-col gap-[clamp(0.53rem,1.1vw,1.25rem)]">
                ...
                <div className="flex flex-row items-center gap-[clamp(0.75rem,1.8vw,2rem)]">
                  ...
                  <button
                    ...
                    className={`flex flex-row justify-center items-center gap-2.5 h-[clamp(1.27rem,2.64vw,3.17rem)] rounded-[33px] border transition-all cursor-pointer select-none ${referredAgent === "default"
                      ? "bg-[#2B2D2F] border-[#000000] text-white"
                      : "bg-white border-[rgba(0,0,0,0.26)] text-black hover:bg-gray-50"
                      }`}
                    style={{ width: "clamp(5.67rem, 11.806vw, 14.167rem)" }}
                  >
                    <div
                  ...
                  <button
                    ...
                    className={`flex flex-row justify-center items-center gap-2.5 h-[clamp(1.27rem,2.64vw,3.17rem)] rounded-[33px] border transition-all cursor-pointer select-none ${referredAgent === "other"
                      ? "bg-[#2B2D2F] border-[#000000] text-white"
                      : "bg-white border-[rgba(0,0,0,0.26)] text-black hover:bg-gray-50"
                      }`}
                    style={{ width: "clamp(7.87rem, 16.389vw, 19.667rem)" }}
                  >
                    <div
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[clamp(1rem,2.7vw,2.5rem)] w-full">
              ...
              <div className="flex flex-col gap-2.5">
                <label className="font-['Plus_Jakarta_Sans'] font-medium text-[clamp(0.53rem,1.11vw,1.33rem)] text-[#3E4A3D]">
                  State
                </label>
                <div
                  className="relative w-full bg-white border border-[#E1E5EF] rounded-xl flex items-center px-3.5 justify-between"
                  style={{
                    maxWidth: "clamp(13.17rem, 27.43vw, 32.917rem)",
                    height: "clamp(1.33rem, 2.778vw, 3.333rem)"
                  }}
                >
                  <select
                    value={stateVal}
                  ...
                  <span className="font-['Inter'] font-normal text-[clamp(0.47rem,0.97vw,1.16rem)] text-[#191C1E] pointer-events-none">
                    {stateVal}
                  </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[clamp(1rem,2.7vw,2.5rem)] w-full">
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <input
                  ...
                  className="w-full bg-white border border-[#E1E5EF] rounded-xl px-3.5 font-['Inter'] font-normal text-[clamp(0.47rem,0.97vw,1.16rem)] text-[#191C1E] focus:outline-none focus:border-[#3E4A3D]"
                  style={{
                    maxWidth: "clamp(13.17rem, 27.43vw, 32.917rem)",
                    height: "clamp(1.33rem, 2.778vw, 3.333rem)"
                  }}
            ...
            <div className="flex flex-col gap-3 w-full">
              <span className="font-['Plus_Jakarta_Sans'] font-semibold text-[clamp(0.53rem,1.11vw,1.33rem)] text-black">
              ...
              <div
                ...
                style={{
                  maxWidth: "clamp(20.9rem, 43.542vw, 52.25rem)",
                  height: "clamp(8.07rem, 16.806vw, 20.167rem)"
                }}
              >
                ...
                <img
                  ...
                  style={{
                    height: isBoundaryConfirmed ? "100%" : "clamp(12.73rem, 26.528vw, 31.833rem)"
                  }}
                />
                ...
                {!isBoundaryConfirmed && (
                  <div
                    ...
                    style={{
                      width: "clamp(5.4rem, 11.25vw, 13.5rem)"
                    }}
                  >
                    <span className="font-['Plus_Jakarta_Sans'] font-semibold text-[clamp(0.47rem,0.97vw,1.16rem)] text-white text-center leading-none tracking-wide drop-shadow-sm">
                    ...
                    <button
                      ...
                      style={{
                        width: "clamp(2.8rem, 5.833vw, 7.0rem)",
                        height: "clamp(0.97rem, 2.014vw, 2.417rem)",
                        fontSize: "clamp(0.33rem, 0.69vw, 0.83rem)",
          ...
          {/* ── Footer / Next button ── */}
          <div className="flex justify-end w-full mt-[clamp(0.96rem,2vw,3.0rem)]">
            <button
              onClick={handleNext}
              ...
              style={{
                width: "clamp(3.27rem, 6.806vw, 8.167rem)",
