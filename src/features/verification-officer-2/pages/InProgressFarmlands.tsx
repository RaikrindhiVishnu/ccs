...
import { inProgressFarmlandsData } from '../Data/inProgressFarmlandsMockData';
import { InProgressFarmlandCard } from '../components/InProgressFarmlandCard';

export const VerificationOfficerInProgressFarmlands = () => {
  ...
  return (
    <div className="w-full flex flex-col pt-[10px]">
      ...
      {/* Grid of Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-full" style={{ gap: '30px', paddingBottom: '40px' }}>
        {inProgressFarmlandsData.map((farmland) => (
...
export default VerificationOfficerInProgressFarmlands;
