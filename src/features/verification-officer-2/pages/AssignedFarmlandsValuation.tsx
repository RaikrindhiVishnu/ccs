                   ...
                   {activeSubTab <= 3 ? (
                       ...
                       <div className="flex flex-col gap-[18px]">
                         ...
                         <div className="flex flex-row flex-wrap gap-4">
                           {['Private Road', 'Government Road'].map(opt => (
                             <button key={opt} onClick={() => setRoadType(opt as any)} className={`flex items-center px-[18px] py-[10px] gap-[10px] rounded-[33px] cursor-pointer ${roadType === opt ? 'bg-[#2B2D2F] border-black' : 'bg-white border-black/25'} border`}>
                       ...
                       <div className="flex flex-col gap-[18px]">
                         ...
                         <div className="flex flex-row flex-wrap gap-4">
                           {['Available', 'Not Available'].map(opt => (
                             <button key={opt} onClick={() => setTxAvailability(opt as any)} className={`flex items-center px-[18px] py-[10px] gap-[10px] rounded-[33px] cursor-pointer ${txAvailability === opt ? 'bg-[#2B2D2F] border-black' : 'bg-white border-black/25'} border`}>
                               <div className="w-3 h-3 rounded-full border-2 border-[#85BFE5] bg-white flex items-center justify-center shrink-0">
                     ...
                     <div className="flex flex-col gap-8 w-full w-full lg:max-w-[640px]">
                       <div className="flex flex-col gap-[24px]">
                         ...
                         <div className="flex flex-row flex-wrap gap-4">
                           {['Available', 'Not Available'].map(opt => (
                             <button key={opt} onClick={() => setGeoAvailability(opt as any)} className={`flex items-center px-[18px] py-[10px] gap-[10px] rounded-[33px] cursor-pointer ${geoAvailability === opt ? 'bg-[#2B2D2F] border-black' : 'bg-white border-black/25'} border`}>
                               <div className="w-3 h-3 rounded-full border-2 border-[#85BFE5] bg-white flex items-center justify-center shrink-0">
                     ...
                     <div className="flex flex-col gap-8 w-full w-full lg:max-w-[640px]">
                       <div className="flex flex-col gap-[24px]">
                         ...
                         <div className="flex flex-row flex-wrap gap-4">
                           {['Available', 'Not Available'].map(opt => (
                             <button key={opt} onClick={() => setRailwayAvailability(opt as any)} className={`flex items-center px-[18px] py-[10px] gap-[10px] rounded-[33px] cursor-pointer ${railwayAvailability === opt ? 'bg-[#2B2D2F] border-black' : 'bg-white border-black/25'} border`}>
                               <div className="w-3 h-3 rounded-full border-2 border-[#85BFE5] bg-white flex items-center justify-center shrink-0">
                     ...
                     <div className="flex flex-col gap-8 w-full w-full lg:max-w-[640px]">
                       <div className="flex flex-col gap-[24px]">
                         ...
                         <div className="flex flex-row flex-wrap gap-4">
                           {['Available', 'Not Available'].map(opt => (
                             <button key={opt} onClick={() => setAirportAvailability(opt as any)} className={`flex items-center px-[18px] py-[10px] gap-[10px] rounded-[33px] cursor-pointer ${airportAvailability === opt ? 'bg-[#2B2D2F] border-black' : 'bg-white border-black/25'} border`}>
                               <div className="w-3 h-3 rounded-full border-2 border-[#85BFE5] bg-white flex items-center justify-center shrink-0">
