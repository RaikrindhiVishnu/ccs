...
const Sidebar: React.FC = () => {
  const iconBtn = (active = false): React.CSSProperties => ({
    ...
    cursor: "pointer",
    flexShrink: 0,
    background: active ? "#5C5C5C" : "transparent",
  });
        ...
        <div style={{ display:"flex", flexDirection:"column", gap:"clamp(2px,0.35vh,4px)", alignItems:"center", width:"100%" }}>
          <div style={iconBtn(true)}>
            <svg width="clamp(14px,1.39vw,20px)" height="clamp(14px,1.39vw,20px)" viewBox="0 0 20 20" fill="none">
              <rect x="2" y="2" width="7" height="7" rx="1.5" stroke="#fff" strokeWidth="1.5"/>
              <rect x="11" y="2" width="7" height="7" rx="1.5" stroke="#fff" strokeWidth="1.5"/>
              <rect x="2" y="11" width="7" height="7" rx="1.5" stroke="#fff" strokeWidth="1.5"/>
              <rect x="11" y="11" width="7" height="7" rx="1.5" stroke="#fff" strokeWidth="1.5"/>
            </svg>
          </div>
          <div style={iconBtn()}>
            <svg width="clamp(14px,1.39vw,20px)" height="clamp(14px,1.39vw,20px)" viewBox="0 0 20 20" fill="none">
              <circle cx="10" cy="7" r="3.5" stroke="#fff" strokeWidth="1.43"/>
              <path d="M2.5 17.5C2.5 14.46 5.91 12 10 12C14.09 12 17.5 14.46 17.5 17.5" stroke="#fff" strokeWidth="1.43" strokeLinecap="round"/>
            </svg>
          </div>
          <div style={iconBtn()}>
            <svg width="clamp(14px,1.39vw,20px)" height="clamp(14px,1.39vw,20px)" viewBox="0 0 20 20" fill="none">
              <path d="M10 2.5L17.5 6.25L10 10L2.5 6.25L10 2.5Z" stroke="#fff" strokeWidth="1.33" strokeLinejoin="round"/>
              <path d="M2.5 10L10 13.75L17.5 10" stroke="#fff" strokeWidth="1.33" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M2.5 13.75L10 17.5L17.5 13.75" stroke="#fff" strokeWidth="1.33" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
        </div>
      </div>
