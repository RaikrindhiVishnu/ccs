...
function InputField({
 ...
 <div className="relative flex items-center w-full bg-[var(--surface-page)] h-[clamp(2.75rem,5.5vh,3.5rem)] rounded-full">
 {Icon && (
 ...
 <Icon
 strokeWidth={1.8}
 className="text-[var(--text-secondary)] w-[clamp(1rem,1.25vw,1.25rem)] lg:w-[1.11vw] h-[clamp(1rem,1.25vw,1.25rem)] "
 />
 </span>
 )}
...
function CardLogo() {
 return (
 <div className="flex flex-col mb-[clamp(0.75rem,2.5vh,1.5rem)] lg:mb-0 shrink-0">
 <img
 src={GlcLogo}
...
function LoginCard({
 ...
 return (
 <div
 className={`absolute top-1/2 -translate-y-1/2 right-4 md:right-[4vw] lg:right-[8.54vw] bg-[var(--surface-card)] flex flex-col box-border shadow-[0px_8px_32px_rgba(0,0,0,0.07)] border border-[var(--border-soft)] rounded-4xl px-[clamp(1.5rem,3.33vw,3rem)] py-[clamp(1rem,3.5vh,3rem)] lg:px-[3.33vw] w-[calc(100%-2rem)] sm:w-[clamp(25rem,38.19vw,34.375rem)] lg:w-[38.19vw] lg:shadow-[0px_1px_3.5px_rgba(0,0,0,0.06)] lg:rounded-[2.22vw] h-auto max-h-[calc(100vh-2.5rem)] ${className}`}
 >
 <div className="flex flex-col flex-1 overflow-y-auto custom-scrollbar pr-1 -mr-1 lg:overflow-visible lg:pr-0 lg:mr-0 gap-[clamp(1rem,2vh,2rem)] ">
 {children}
 </div>
 </div>
 );
...
function LoginScreen({
 ...
 <div className="mb-[clamp(0.75rem,2.5vh,1.5rem)] lg:mb-0 lg:flex lg:flex-col lg:items-start shrink-0">
 <h1 className="font-heading font-bold text-[var(--text-heading)] text-[clamp(1.25rem,1.66vw,1.5rem)] lg:text-[1.67vw] lg:leading-[2.78vw] leading-snug tracking-[-0.05625rem] lg:tracking-[-0.06vw] m-0 mb-[clamp(0.25rem,0.4vw,0.5rem)] ">
 Role Manager Login
 </h1>
...
function ForgotPasswordScreen({
 ...
 <div className="mb-[clamp(0.75rem,2.5vh,1.5rem)] lg:mb-0 lg:flex lg:flex-col shrink-0">
 <h2 className="font-heading font-bold text-[var(--text-heading)] text-[clamp(1.25rem,1.66vw,1.5rem)] lg:text-[1.67vw] lg:leading-[2.92vw] leading-snug tracking-[-0.05625rem] m-0 mb-[clamp(0.25rem,0.4vw,0.5rem)] ">
 Forgot Your Password?
 </h2>
 <p className="font-sans font-normal text-[var(--text-secondary)] text-[clamp(0.875rem,1.11vw,1rem)] lg:text-[1.11vw] lg:leading-[1.53vw] leading-normal m-0">
...
function ForgotPasswordSuccessScreen({
 ...
 ">
 <div className="
 w-[clamp(7rem,12.5vw,11.25rem)] lg:w-[12.5vw]
 h-[clamp(7rem,12.5vw,11.25rem)] 
 rounded-[7.2px] bg-[rgba(39,128,196,0.08)]
 flex items-center justify-center
 ">
 <div className="
 w-[70%] lg:w-[8.75vw]
 h-[70%] 
 rounded-[7.2px] bg-[#2780C4]
 flex items-center justify-center
 ">
 <svg viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[55%] h-[55%]">
 <path d="M12 31L24 43L49 18" stroke="white" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
 </svg>
 </div>
 </div>
 </div>
...
function UpdateDefaultPasswordScreen({
 ...
 <div className="mb-[clamp(0.75rem,2.5vh,1.5rem)] lg:mb-0 lg:flex lg:flex-col lg:items-start shrink-0">
 <h2 className="font-sans font-bold text-[var(--text-heading)] text-[clamp(1.25rem,1.66vw,1.5rem)] lg:text-[1.67vw] lg:leading-[2.78vw] leading-snug m-0 mb-[clamp(0.25rem,0.4vw,0.5rem)] ">
...
function ChangePasswordScreen({ onDone, oldPassword }: { onDone: () => void; oldPassword: string }) {
 ...
 const ChangeInputField = ({ label: fieldLabel, ...rest }: InputFieldProps) => (
 ...
 <rest.icon
 strokeWidth={1.8}
 className="text-[var(--text-secondary)]/60 w-[clamp(1rem,1.25vw,1.25rem)] lg:w-[1.11vw] h-[clamp(1rem,1.25vw,1.25rem)] "
 />
 </span>
 )}
 <input
 ...
 className={`w-full h-full bg-transparent border-none outline-none font-sans font-normal text-[var(--text-primary)] placeholder:text-[var(--text-secondary)]/50 rounded-full text-[clamp(0.875rem,1.11vw,1rem)] lg:text-[1.11vw] ${
 rest.icon ? "pl-[clamp(2.5rem,3.47vw,3.125rem)] lg:pl-[3.33vw]" : "pl-[clamp(0.875rem,1.11vw,1.25rem)] lg:pl-[1.11vw]"
 } ${
 rest.rightEl ? "pr-[clamp(2.5rem,3.47vw,3.125rem)] lg:pr-[3.33vw]" : "pr-[clamp(0.875rem,1.11vw,1.25rem)] lg:pr-[1.11vw]"
 }`}
 />
 {rest.rightEl && (
 <span className="absolute flex items-center right-[clamp(0.875rem,1.11vw,1.25rem)] lg:right-[1.11vw]">
 ...
 <div className="mt-[clamp(0.75rem,2.5vh,1.5rem)] ">
 <PrimaryButton type="submit" disabled={isLoading} variant="secondary" className=" lg:rounded-full lg:text-[1.11vw]">
